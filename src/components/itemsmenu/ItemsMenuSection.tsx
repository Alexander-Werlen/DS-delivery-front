...
import { ItemMenu, ItemMenuAdvancedFilters } from "@/shared.types"
...
function ItemsMenuSection() {
    ...
    const triggerFetchItemsMenu = async (filter?: ItemMenuAdvancedFilters) => {
        getAllItemsMenu(filter).then((response) => {
    ...
    return (
        <div className="mt-2">
            ...
            <DataTable data={listaItemsMenu} triggerFetchData={triggerFetchItemsMenu} />
